...
(function () {
    ...
    var panZoomFunctions = {
        ...
        PanZoom = function (el, options) {
            ...
            // changing deltaX and deltaY parameters for viewbox and calling repaint() based on val and center point
            function applyZoom(val, centerPoint) {
                // console.log("ZOOMING!!!!:",val, centerPoint, me)
                if (!me.enabled) {
                    return false;
                }
                me.currZoom += val;
